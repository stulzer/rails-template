    ...
    __alterButtons: function(name,alter) {
      ...
      for (i=0;i<buttonsArray.length;i++) {
        ...
        for (y=0;y<btnGroups.length;y++) {
          ...
          for (z=0;z<buttons.length;z++) {
            ...
            btnGroupContainer.append('<button class="' +btnClass +' btn-small" title="' +button.title +'" data-provider="' +ns +'" data-handler="' +buttonHandler +'"' +buttonToggle +'><i class="' +button.icon +'"></i> ' +btnText +'</button>');
      ...
      if (this.$editor === null) {
        ...
        if (options.savable) {
          ...
          editorFooter.append('<button class="btn btn-success" data-provider="' +ns +'" data-handler="' +saveHandler +'"><i class="icon icon-white icon-ok"></i> Save</button>');
      ...
      [{
        ...
        data: [{
          ...
          callback: function(e){
            ...
            if (selected.length === 0) {
              // Give extra word
              chunk = 'digite a descrição to link aqui';
            } else {
              chunk = selected.text;
            }

            link = prompt('Insira o link','http://');
        ...
        data: [{
          ...
          callback: function(e){
            ...
            if (selected.length === 0) {
              // Give extra word
              chunk = 'digite o texto o item da lista';
        ...
        data: [{
          ...
          title: 'Preview',
          btnText: 'Preview',
          btnClass: 'btn btn-inverse for-preview',
